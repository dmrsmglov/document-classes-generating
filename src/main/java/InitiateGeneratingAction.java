    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        if (psiFile != null && psiFile.getName().endsWith(".java")) {
            ...
            if (aClass != null) {
                ...
                Notifications.Bus.notify(new Notification("Error","Cannot generate documentation","Java class not found", NotificationType.ERROR));
            }
        } else {
            Notifications.Bus.notify(new Notification("Error","Cannot generate documentation","Java file not found", NotificationType.ERROR));
        }
    }
}
